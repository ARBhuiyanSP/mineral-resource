...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <i class="fas fa-table"></i> Site Entry Form
		</div>
        <div class="card-body">
                ...
                <form action="" method="post" name="add_name" id="add_name">
                    <div class="row" id="div1" style="">
                        <div class="col-xs-3">
                            <div class="form-group">
                                <label>Site ID</label>
                                <input type="text" name="package_id" id="package_id" class="form-control" readonly="readonly" value="<?php echo getDefaultCategoryCode('packages', 'package_id', '03d', '001', 'SITE-') ?>">
                            </div>
                        </div>
						<div class="col-xs-3">
                            <div class="form-group">
