...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-header">
            ...
            Port To Port Transfer Entry Form</div>
        <div class="card-body">
                    ...
                    <div class="row" id="div1" style="">
						<div class="col-xs-2">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="port_transfer_date" id="port_transfer_date" class="form-control datepicker" value="<?php echo date('Y-m-d'); ?>">
							</div>
						</div>
						<div class="col-xs-2">
							<div class="form-group">
						...
						<div class="col-xs-4">
							<div class="form-group">
								...
								<input type="hidden" name="from_port" id="from_port" class="form-control" readonly="readonly" value="<?php echo $_SESSION['logged']['port_id']; ?>">
							</div>
						</div>
						...
						<div class="col-xs-4">
							<div class="form-group">
								<label for="id">To Port</label><span class="reqfield"> ***required</span>
								<select class="form-control" id="main_sub_item_id" name="to_warehouse" onchange="getItemCodeByParam(this.value, 'inv_warehosueinfo', 'port_id', 'port_id');">
									...
									<?php
									$warehouse_id = $_SESSION['logged']['warehouse_id'];
									$parentCats = getTableDataByTableNameByPort('inv_warehosueinfo','','name');
						...
						<div class="col-xs-12">
							<div class="form-group">
								<div class="modal-footer">
									<input type="submit" name="port_transfer_submit" id="submit" class="btn btn-block"  style="background-color:#007BFF;color:#ffffff;" value="SAVE" />
								</div>    
							</div>
						</div>
					</div>	 
