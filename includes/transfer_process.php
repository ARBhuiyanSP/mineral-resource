...
if (isset($_POST['port_transfer_submit']) && !empty($_POST['port_transfer_submit'])) {
    ...
    */
    $query2 = "INSERT INTO `inv_port_transfer` (`port_transfer_id`,`port_transfer_date`,`from_port`,`from_warehouse`,`to_port`,`to_warehouse`,`remarks`) VALUES ('$port_transfer_id','$port_transfer_date','$from_port','$from_warehouse','$to_port','$to_warehouse','$remarks')";
    $result2 = $conn->query($query2);    
