...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-header">
            ...
            Material Project Return Report
					...
					<div class="col-sm-10">
						<div class="row">
							<div class="col-sm-6">	
								...
								<h5>E-engineering Ltd</h5><span>Water Logging Project</span></br></p></div>
							<div class="col-sm-6">
								<table class="table table-bordered">
									...
									<tr>
										<th>Return Date:</th>
										<td><?php
											$sqld = "select * from `inv_project_return` where `return_id`='$return_id'";
						...
						<table class="table table-bordered" id="material_receive_list"> 
							...
							<tbody id="material_receive_list_body">
								<?php
								$transfer_id=$_GET['no'];
								$sql = "select * from `inv_project_returndetail` where `return_id`='$return_id'";
								...
								<tr>
									...
									<td>
										<?php 
										$sql2 = "SELECT sum(return_qty) FROM  `inv_project_returndetail` where `return_id`='$return_id'";
