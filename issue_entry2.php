<?php include 'header.php' ?>
	<script type="text/javascript">
        $(document).ready(function(){
            ...
            $(document).on('keydown', '.partyname', function() {
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                                ...
                                if(len > 0){
                                    ...
                                    var memono = response[0]['memono'];
                                    var pb_date = response[0]['pb_date'];
                                    var pb_party_id = response[0]['pb_party_id'];
                                    var pb_dr_amount = response[0]['pb_dr_amount'];
                                    var pb_cr_amount = response[0]['pb_cr_amount'];
                                    var pb_remark = response[0]['pb_remark'];

                                    document.getElementById('memono_'+index).value = memono;
                                    document.getElementById('pb_date_'+index).value = pb_date;
                                    document.getElementById('pb_party_id_'+index).value = pb_party_id;
                                    document.getElementById('pb_dr_amount_'+index).value = pb_dr_amount;
                                    document.getElementById('pb_cr_amount_'+index).value = pb_cr_amount;
                                    document.getElementById('pb_remark_'+index).value = pb_remark;
                                }  
                            }
                        });
                        return false;
                    ...
                    <div class="row" id="div1" style="">
						...
						<div class="col-xs-2">
							<div class="form-group">
								...
								<input type='text' name="party_name" class='form-control partyname' id='partyname_1' placeholder='Enter Party Name' required>
							</div>
						</div>
						<div class="col-xs-2">
                            <div class="form-group">
						...
						<div class="col-xs-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="" id="pb_dr_amount_1" class="form-control pb_dr_amount" readonly >
                            </div>
                        </div>
						<div class="col-xs-2">
                            <div class="form-group">
                                <label for="id">Last MR No</label>
                                <input type="text" name="" id="memono_1" class="form-control memono" readonly >
                            </div>
                        </div>
						<div class="col-xs-2">
                            <div class="form-group">
                                <label for="id">Last MR Date</label>
                                <input type="text" name="" id="pb_date_1" class="form-control pb_date" readonly >
                            </div>
                        </div>
