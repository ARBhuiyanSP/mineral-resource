...
<div class="card mb-3">
    <div class="card-header">
		...
		<button class="btn btn-success linktext"> Sitewise Return Report </button>
	</div>
    <div class="card-body">
		...
		<div class="col-md-10" id="printableArea">
			<div class="row">
				...
				<table id="" class="table table-bordered">
					...
					<tbody>
						<?php
							$sql	=	"SELECT * FROM `inv_return` where `from_warehouse` = '$warehouse_id' AND `return_date` BETWEEN '$from_date' AND '$to_date';";
