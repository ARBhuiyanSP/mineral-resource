...
<div class="card mb-3">
    <div class="card-header">
		<button class="btn btn-info linktext" onclick="window.location.href='return_report.php'">Return Report Search</button>
		<button class="btn btn-success linktext"> Materialwise Return Report </button>
		<button class="btn btn-info linktext" onclick="window.location.href='sitewise_return_report.php'"> Sitewise Return Report </button>
	</div>
    <div class="card-body">
					...
					<tbody>
						<?php
							if($_SESSION['logged']['user_type'] !== 'whm'){
								...
								$sql	=	"SELECT * FROM `inv_return` where `to_warehouse` = '$warehouse_id' AND `return_date` BETWEEN '$from_date' AND '$to_date';";
							}
						...
						<tr style="background-color:#E9ECEF;">
							...
							<td colspan="4">From Site : 
											<?php 
											$dataresult =   getDataRowByTableAndId('inv_warehosueinfo', $row['from_warehouse']);
											echo (isset($dataresult) && !empty($dataresult) ? $dataresult->name : '');
											?>
						...
						<?php
							...
							$sqlall	=	"SELECT * FROM `inv_returndetail` WHERE `material_id`='$material_id' AND `return_id` = '$return_id';";
