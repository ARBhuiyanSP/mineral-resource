                        ...
                        <tr>  
							<td>
                                <div class="form-group">
									<label for="sel1">From Project:</label>
									<select class="form-control" id="project_id" name="project_id">
										<option value="">Select</option>
										<?php
										$warehouse = getTableDataByTableName('projects','','name');
		...
		<div class="col-md-10" id="printableArea">
			<div class="row">
				<div class="col-sm-12">	
					<center>
						<p>
							...
							<span>Project to Project Transfer Report</span><br>
							<span>Transfer From : <?php echo getDataRowByTableAndId('projects', $project_id)->name; ?></span><br>
				...
				<table id="" class="table table-bordered">
					...
					<tbody>
						<?php
							$sql	=	"SELECT * FROM `inv_projectstransfer` where `from_project` = '$project_id' AND `transfer_date` BETWEEN '$from_date' AND '$to_date';";
						...
						<tr style="background-color:#E9ECEF;">
							...
							<td colspan="2">Transfer To : <?php echo getDataRowByTableAndId('projects', $row['to_project'])->name; ?></td>
						</tr>
						<?php
							$totalQty = 0;
							$totalAmount = 0;
							$transfer_id = $row['transfer_id'];
							$sqlall	=	"SELECT * FROM `inv_projectstransferdetails` WHERE `transfer_id` = '$transfer_id';";
