							...
							<div class="col-sm-6">
								<table class="table table-bordered">
									...
									<tr>
										...
										<td>
											<?php 
											$dataresult =   getDataRowByTableAndId1('tb_party', $rowd['party_id']);
											echo (isset($dataresult) && !empty($dataresult) ? $dataresult->partyname : '').'</br>'.(isset($dataresult) && !empty($dataresult) ? $dataresult->Address : '');
											?>
										</td>
									</tr>
								</table>
