					...
					<div class="col-sm-10">
							...
							<div class="col-sm-6">
								<table class="table table-bordered">
									...
									<tr>
										<th>Transfer Date:</th>
										<td><?php
											$sqld = "select * from `inv_projectstransfer` where `transfer_id`='$transfer_id'";
									...
									<tr>
										...
										<td>
											<?php 
											$dataresult =   getDataRowByTableAndId('projects', $rowd['from_project']);
									...
									<tr>
										...
										<td>
											<?php 
											$dataresult =   getDataRowByTableAndId('inv_warehosueinfo', $rowd['from_site']);
											echo (isset($dataresult) && !empty($dataresult) ? $dataresult->name : '');
											?>
										</td>
									</tr>
									<tr>
										...
										<td>
											<?php 
											$dataresult =   getDataRowByTableAndId('projects', $rowd['to_project']);
											echo (isset($dataresult) && !empty($dataresult) ? $dataresult->name : '');
											?>
										</td>
									</tr>
						...
						<table class="table table-bordered" id="material_receive_list"> 
							...
							<tbody id="material_receive_list_body">
								<?php
								$transfer_id=$_GET['no'];
								$sql = "select * from `inv_projectstransferdetails` where `transfer_id`='$transfer_id'";
